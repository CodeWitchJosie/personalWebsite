      ...
      <Container>
        <Row>
          ...
          <div className='col-lg-6'>
            <p>
              I am a software engineer with over twelve years of experience. I am passionate about solving human-centric
              problems. That includes developing intuitive user interfaces as well as improving development processes,
              following clean code practices so that others are able to maintain my code, and creating collaborative
              team cultures where people enjoy coming to work.
            </p>
            <p>
            ...
            <p>
              I am interested in giving technical talks to our local community. Please reach out with a when, where, and
              general topic if you are interested in inviting me to your event.
            </p>
            <p>Please note that this website is still a work in progress.</p>
